...
Route::middleware( [
    ...
    Route::prefix( 'aaparpay' )->group( function () {
        ...
        Route::match( ['get', 'post'], 'recharge-success-for-us', [AamarpayController::class, 'rechargesuccess'] );
    ...
    Route::middleware( 'tenantAuth' )->group( function () {
        ...
        Route::prefix( 'tenant-dropshipper' )->group( function () {
            ...
            Route::post( 'single/product/add-profit/{id}', [SingleProductController::class, 'AffiliatorProductSingleAddProfit'] );
